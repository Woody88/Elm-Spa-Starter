		...
		switch (_p0.ctor) {
			...
			case 'Tag':
				return A2(
					_elm_lang$core$List$concatMap,
					fn(
						_eeue56$elm_html_query$ElmHtml_Query$Tag(_p0._0)),
					list);
			case 'Text':
				return A2(
					_elm_lang$core$List$concatMap,
	...
	switch (_p5.ctor) {
		...
		case 'Attribute':
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(_p5._0.name),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' ',
						_elm_lang$core$Basics$toString(_p5._0.value))));
		case 'BoolAttribute':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'attribute ',
...
var _user$project$App$Inc = {ctor: 'Inc'};
		...
		},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Elm Webpack Starter, featuring hot-loading'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Click on the button below to increment the state.'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$App$Inc),
										_1: {ctor: '[]'}
									}
								},
								{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Then make a change to the source code and see how the state is retained after you recompile.'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('And now don\'t forget to add a star to the Github repo '),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('https://github.com/simonh1000/elm-webpack-starter'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('elm-webpack-starter'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Test_Generated_Main3081456036$main = A2(
	...
	_elm_community$elm_test$Test$concat(
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Example$fuzzTest,
					_1: {
						ctor: '::',
						_0: _user$project$Example$unitTest,
						_1: {
							ctor: '::',
							_0: _user$project$Example$viewTest,
							_1: {ctor: '[]'}
						}
					}
				}),
...
Elm['Test']['Generated']['Main3081456036'] = Elm['Test']['Generated']['Main3081456036'] || {};
if (typeof _user$project$Test_Generated_Main3081456036$main !== 'undefined') {
    _user$project$Test_Generated_Main3081456036$main(Elm['Test']['Generated']['Main3081456036'], 'Test.Generated.Main3081456036', undefined);
}
...
var report = "console";
var pipeFilename = "/tmp/elm_test-18074.sock";
